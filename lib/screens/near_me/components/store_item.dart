...
class StoreItem extends StatelessWidget {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              buildClipRRect(0, topLeft: 10),
              const SizedBox(width: 2),
              buildClipRRect(1, topRight: 10),
            ],
          ),
          Padding(
  ...
  Widget buildClipRRect(int index, {double topLeft = 0, double topRight = 0}) {
    return ClipRRect(
      ...
      child: Image.network(
        recommendStore.storeImages[index],
        width: 143,
        height: 100,
        fit: BoxFit.cover,
      ),
