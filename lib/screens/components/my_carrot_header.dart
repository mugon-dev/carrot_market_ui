...
class MyCarrotHeader extends StatelessWidget {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                _buildRoundTextButton('관심내역', FontAwesomeIcons.heart),
              ],
            ),
          ],
        ),
  ...
  Container _buildRoundTextButton(String title, IconData iconData) {
    return Container(color: Colors.orange[100], height: 60, width: 60);
  }

  Widget _buildProfileButton() =>
      Container(color: Colors.blue[100], height: 45);
